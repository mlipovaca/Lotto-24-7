/*  Generated by CHR bootstrap compiler
    From: /home/janw/src/swipl/packages/chr/chr_translate.chr
    Date: Sun Jan 00 00:00:00 1900
...
auxiliary_constraints_declarations(A, B, C, F) :-
    findall(D,
            auxiliary_constraints_declaration(A, B, C, D),
            E),
    flatten(E, F).
...
'$enumerate_constraints'(type_alias, C) :-
    nb_current('$chr_store_global_list_chr_translate____type_alias___2', A),
    member(B, A),
    B=suspension(_, _, _, _, _, D, E),
    C=type_alias(D, E).
